...
app.prepare().then(() => {
    const server = createServer(async (req, res) => {
        try {
            ...
            res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, cache-control, x-security-level, x-request-timestamp, x-client-id');
            ...
            if (req.method === 'OPTIONS') {
                res.writeHead(200, {
                    ...
                    'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Requested-With, cache-control, x-security-level, x-request-timestamp, x-client-id',
