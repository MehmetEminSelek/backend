...
async function createAuditLog({
    ...
    try {
        // Login denemeleri için personelId null olabilir, bu durumda 'SYSTEM' kullan
        const auditPersonelId = personelId || (action === 'LOGIN' ? 'SYSTEM' : null);

        await prisma.auditLog.create({
            data: {
                personelId: auditPersonelId,
                action,
                tableName,
